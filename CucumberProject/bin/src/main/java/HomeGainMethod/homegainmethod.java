...
public class homegainmethod {
	 ...
	 */
		...
		/**
		 * Get the text from UI and verify if expected
		 * @param strAttribute
		 * @param strText
		 */
		...
		/**
		 * Click the button to navigate to next step/page
		 * @param strAttribute
		 */
		...
		/**
		 * After test close the browser and quit
		 */
		@After
